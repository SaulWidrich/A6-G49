...
6. Should we transform the daily rate (e.g. `sqrt` or `log1p`) because computing the spectrum?
7. Should we use generalized Lomb-Scargle (i.e. the version in the `spectral` package)) or not (i.e. the version in the `lomb` package).
